...
// StrictMode double-invokes effects in dev which causes Sentry's ErrorBoundary
// to call useRef on a null React instance → "Cannot read properties of null
// (reading 'useRef')". Sentry already captures all errors via its global
// window.onerror / unhandledrejection handlers above, so the boundary is still
// fully functional without StrictMode.
